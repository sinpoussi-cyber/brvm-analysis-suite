...
#### **Étape 2 : Mettre à Jour le Workflow pour Exécuter la Migration**

Maintenant, nous allons modifier le workflow sur la branche `develop` pour qu'il exécute ce nouveau script **une seule fois**.

**Action :** Modifiez votre fichier `.github/workflows/daily_brvm_analysis.yml` sur la branche `develop` pour qu'il ressemble à ceci.

```yaml
# ==============================================================================
# Workflow GitHub Actions pour la MIGRATION DE DONNÉES (À exécuter une seule fois)
# ==============================================================================
  ...
  run-migration:
    ...
    steps:
      - name: Checkout develop branch
        ...
        with:
          ref: develop # Assurez-vous que cette ligne est bien présente
      ...
      - name: Run Database Setup (Just in case)
        env:
